    ...
    <section id="servicos" className="py-16 px-12 bg-white">
      <div className="max-w-6xl mx-auto">
        ...
        <p className="text-center mb-12 max-w-3xl mx-auto" style={{color: "#7B5299"}}>
          Oferecemos uma gama de serviços voltados para atender às necessidades individuais de cada residente. Nosso objetivo é garantir conforto, segurança, qualidade de vida é uma rotina enriquecedora, sempre com carinho e atenção especial.
        </p>
